{{-- Organization Insights Modal --}}
<!-- Button to trigger modal -->
<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#insightsModal{{ $organization->id }}">
                                ...
                                @if($completeness < 100)
                                    <div class="alert alert-info mb-0">
                                        <small>
                                            ...
                                            <strong>Tip:</strong> Complete your profile to increase visibility and trust.
                                        </small>
                                    </div>
                                @else
